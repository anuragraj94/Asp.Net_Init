<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Support.aspx.cs" Inherits="WebApplication1.Support" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="cp_div">
      <!--left panel starts here -->
      <div class="abt_lp_div" style="margin-left:44px;"> <span class="lp_abt"><span style=" font:28px arial;color:#1535AB;">Support</span><br />
